    ...
    <div class="sidebar content-box" style="display: block;">
        <ul class="nav">
            ...
            <li class="submenu">
                ...
                <a href="#"><i class="glyphicon glyphicon-menu-hamburger"></i></i>Products
            ...
            <li class="submenu">
                ...
                <a href="#"><i class="glyphicon glyphicon-menu-hamburger"></i></i>Categories
                    <span class="caret pull-right"></span>
                </a>
                <ul>
                    <li>
            ...
            <li class="submenu">
                <a href="#"><i class="glyphicon glyphicon-menu-hamburger"></i></i>Orders
                    <span class="caret pull-right"></span>
                </a>
                <ul>
                    <li>
